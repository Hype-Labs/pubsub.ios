...
class MessagesViewController: UITableViewController
{
    ...
    override func viewDidLoad()
    {
        ...
        LogUtils.log(prefix: HpsConstants.LOG_PREFIX, logMsg: "Add observer to " + HpsConstants.NOTIFICATION_MESSAGES_VIEW_CONTROLLER + (subscription?.serviceName)!)
    ...
    func refreshMessages()
    {
        DispatchQueue.main.async {
            LogUtils.log(prefix: HpsConstants.LOG_PREFIX, logMsg: "Refreshing messages")
